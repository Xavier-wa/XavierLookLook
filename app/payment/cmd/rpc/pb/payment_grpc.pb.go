...
const (
	Payment_CreatePayment_FullMethodName                    = "/pb.payment/CreatePayment"
	Payment_GetPaymentBySn_FullMethodName                   = "/pb.payment/GetPaymentBySn"
	Payment_UpdateTradeState_FullMethodName                 = "/pb.payment/UpdateTradeState"
	Payment_GetPaymentSuccessRefundByOrderSn_FullMethodName = "/pb.payment/GetPaymentSuccessRefundByOrderSn"
)
...
func (c *paymentClient) GetPaymentBySn(ctx context.Context, in *GetPaymentBySnReq, opts ...grpc.CallOption) (*GetPaymentBySnResp, error) {
	...
	err := c.cc.Invoke(ctx, Payment_GetPaymentBySn_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentClient) UpdateTradeState(ctx context.Context, in *UpdateTradeStateReq, opts ...grpc.CallOption) (*UpdateTradeStateResp, error) {
	...
	err := c.cc.Invoke(ctx, Payment_UpdateTradeState_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *paymentClient) GetPaymentSuccessRefundByOrderSn(ctx context.Context, in *GetPaymentSuccessRefundByOrderSnReq, opts ...grpc.CallOption) (*GetPaymentSuccessRefundByOrderSnResp, error) {
	...
	err := c.cc.Invoke(ctx, Payment_GetPaymentSuccessRefundByOrderSn_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
